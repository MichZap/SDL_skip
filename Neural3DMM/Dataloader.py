...
def load_data(p,root_dir,folder, axis, typ ="Coma", flip = True, rot = True):
    ...
    train_set = autoencoder_dataset(root_dir = root_dir, points_dataset = df_train, mean=mean,transform=transform,dummy_node = True, mode="train",typ = typ)
    val_set = autoencoder_dataset(root_dir = root_dir, points_dataset = df_val, mean=mean,dummy_node = True, mode ="val", typ = typ)
...
class autoencoder_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.isfile(path):
            ...
            verts_init = torch.tensor(verts_init)
